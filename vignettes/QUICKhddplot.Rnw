...
## good indication of behavior in the extreme tail.
library(multtest, quietly=TRUE)
GolubB2 <- GolubB[,tissue.mfB!="PB:m"]
cl.mfB2 <-  (unclass(tissue.mfB)-1)[tissue.mfB!="PB:m"]
GolubB.maxT <- mt.maxT(GolubB2, cl.mfB2, test="f", B=1000)
@ %
